...
> Classic DSP on raw ECG and PPG — band-pass, beat detection, denoising, and adaptive motion rejection: the toolkit that turns a noisy wrist sensor into a heart-rate number.
>
...
cd dsp-health-signals/filters-and-detection
